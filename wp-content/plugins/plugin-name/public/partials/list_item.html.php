<div class="col-xs-12 col-sm-6 col-md-3 table-responsive">
<table class="nwm-beerlist-table-info table">
	<tbody>
		<tr>
			<td class="nwm-beerlist-image-panel" colspan="2">
				<div class="nwm-beerlist-photo">
		...
		<tr>
			<td class="nwm-beerlist-user-rating" colspan="2">
				<?php
				...
				?>
					<div class="nwm-rating-radio">
						<input id="<?php echo $cerveza->ID.'-1';?>" type="radio" class="1" <?php echo ($rating>=1)?'checked="checked"':'';?> />
						<label for="<?php echo $cerveza->ID.'-1';?>"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label>

				    <input id="<?php echo $cerveza->ID.'-2';?>" type="radio" class="2" <?php echo ($rating>=2)?'checked="checked"':'';?> />
				    <label for="<?php echo $cerveza->ID.'-2';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				    <input id="<?php echo $cerveza->ID.'-3';?>" type="radio" class="3" <?php echo ($rating>=3)?'checked="checked"':'';?> />
				    <label for="<?php echo $cerveza->ID.'-3';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				    <input id="<?php echo $cerveza->ID.'-4';?>" type="radio" class="4" <?php echo ($rating>=4)?'checked="checked"':'';?> />
				    <label for="<?php echo $cerveza->ID.'-4';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				    <input id="<?php echo $cerveza->ID.'-5';?>" type="radio" class="5" <?php echo ($rating>=5)?'checked="checked"':'';?> />
				    <label for="<?php echo $cerveza->ID.'-5';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				    <input type="hidden" class="my-cheve-id" value="<?php echo $cerveza->ID;?>" />
			    </div>
				<?php } else { ?>
					<div class="nwm-rating-radio-inactive">
						<input id="<?php echo $cerveza->ID.'-1';?>" type="radio" class="1" data-toggle="modal" data-target="#myModal" />
						<label for="<?php echo $cerveza->ID.'-1';?>"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label>

				        <input id="<?php echo $cerveza->ID.'-2';?>" type="radio" class="2" data-toggle="modal" data-target="#myModal" />
				        <label for="<?php echo $cerveza->ID.'-2';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				        <input id="<?php echo $cerveza->ID.'-3';?>" type="radio" class="3" data-toggle="modal" data-target="#myModal" />
				        <label for="<?php echo $cerveza->ID.'-3';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				        <input id="<?php echo $cerveza->ID.'-4';?>" type="radio" class="4" data-toggle="modal" data-target="#myModal" />
				        <label for="<?php echo $cerveza->ID.'-4';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

				        <input id="<?php echo $cerveza->ID.'-5';?>" type="radio" class="5" data-toggle="modal" data-target="#myModal" />
				        <label for="<?php echo $cerveza->ID.'-5';?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
		...
		<tr class="nwm-beerlist-beer-info nwm-beerlist-beer-info-first">
			<td colspan="2">
				<?php $productor = get_post_meta($cerveza->ID, 'beer_productor', true);?>
				<?php echo $cerveza->post_title;?> de
				<a href="<?php echo get_permalink(get_page_by_title($productor,'object','brewery'));?>">
					<?php echo (isset($productor))?$productor:'-';?>
				</a>
			</td>
		</tr>
		<tr class="nwm-beerlist-beer-info">
			<?php $aux_type_of_beer = wp_get_post_terms( $cerveza->ID, 'type_of_beer' );?>
			<td colspan="2"><?php echo (empty($aux_type_of_beer))?'-':$aux_type_of_beer[0]->name;?></td>
		</tr>
		<tr class="nwm-beerlist-beer-info">
			<td colspan="2"><?php echo get_post_meta($cerveza->ID, 'beer_alcohol', true);?> Alcohol</td>
		</tr>
		<tr class="nwm-beerlist-beer-info-title">
			<td colspan="2" style="text-align:center"><h3>VEREDICTO</h3></td>
		</tr>
		<tr class="nwm-beerlist-beer-info nwm-beerlist-rating-row">
			<?php
				$sql = 'SELECT ID FROM wp_posts,wp_postmeta ';
				$sql.= "WHERE (meta_key = 'cerveza_id' AND meta_value = '$cerveza->ID') ";
			...
			?>
			<td class="nwm-beerlist-maestre-rating">
			...
			<td class="nwm-beerlist-maestre-rating-label">Gran Maestre</td>
		</tr>
		<tr class="nwm-beerlist-beer-info">
			<td colspan="2"><div class="nwm-beerlist-row-separator"></div></td>
		</tr>
		<tr class="nwm-beerlist-beer-info  nwm-beerlist-beer-info-last">
			<?php
			...
			?>
			<td class="nwm-beerlist-community-rating">
			...
			<td class="nwm-beerlist-community-rating-label">Comunidad LOC</td>
		</tr>
	</tbody>
</table>
</div>
